...
$buildCommand = @(
  "call `"$vcvars`" >nul",
  "cl /nologo /O2 /D SODIUM_STATIC /I `"$includeDir`" stellar_vanity_parallel.c /Fe:stellar_vanity_parallel.exe /link /LIBPATH:`"$libDir`" libsodium.lib advapi32.lib ws2_32.lib user32.lib"
) -join " && "
